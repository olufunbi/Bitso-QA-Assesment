...
describe('Verify Error message displayed when deposit is trigerred for BTC', () => {
  ...
  it('clicks on the BTC asset, deposit button and verifies error message', () => {
    
    // Click on the BTC currency
    cy.xpath(SELECTORS.BTC).click()
