...
describe('Verify Error message displayed when deposit is trigerred for MANA', () => {
  ...
  it('clicks on the MANA asset, deposit button and verifies error message', () => {
    
    // Click on the MANA currency
    cy.xpath(SELECTORS.MANA).click()
