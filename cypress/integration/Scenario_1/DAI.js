...
describe('Verify Error message displayed when deposit is trigerred for DAI', () => {
  ...
  it('clicks on the DAI asset, deposit button and verifies error message', () => {
    
    // Click on the DAI currency
    cy.xpath(SELECTORS.DAI).click()
